...
/*   Updated: 2024/04/26 21:42:10 by ledos-sa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	c->vars.mlx = mlx_init();
	c->vars.win = mlx_new_window(c->vars.mlx, TILE * c->size[0] , TILE * c->size[1], "Cub3d");
	c->vars.img = mlx_new_image(c->vars.mlx, TILE * c->size[0], TILE * c->size[1]);
